...
export const Footer: React.FC = () => {
  const socialLinks = [
    ...
    {
      icon: Facebook,
      href: "https://www.facebook.com/profile.php?id=61584881488185",
    },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-subtext max-w-sm text-lg font-medium leading-relaxed mb-10">
              AI-driven performance creatives that help D2C brands scale
              profitably. We blend data with design.
            </p>

            <div>
              <h5 className="font-extrabold text-[#111111] mb-4 uppercase tracking-widest text-xs">
                Our Locations
              </h5>
              <div className="flex flex-col sm:flex-row gap-x-12 gap-y-4 text-subtext font-medium text-sm">
          ...
          <div>
            <h4 className="font-extrabold text-[#111111] mb-8 uppercase tracking-widest text-xs">
              Services
            </h4>
            <ul className="space-y-4 text-subtext font-bold">
              <li>
                <a
                  href="#"
                  className="hover:text-[#111111] hover:text-primary transition-colors"
                >
                  AI UGC Videos
                </a>
              </li>
