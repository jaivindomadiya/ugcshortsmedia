        ...
        <div className="flex flex-col md:flex-row gap-12 md:gap-20 items-start">
          <div className="md:w-1/3 md:sticky  top-32">
            ...
            <p className="text-xl text-subtext font-medium mb-8 md:mb-10 leading-relaxed">
              We combine human creativity with AI speed to deliver results that
          ...
          <div className="md:w-2/3 grid grid-cols-1 gap-4 md:gap-6">
            {BENEFITS.map((benefit) => (
              <div
                key={benefit.id}
                className="bg-secondary p-6 md:p-10 rounded-[2rem] md:rounded-[2.5rem] hover:bg-primary transition-colors duration-300 group flex items-start space-x-4 md:space-x-6"
              >
                ...
                <div>
                  <h3 className="text-xl md:text-2xl font-bold text-[#111111] mb-2">
                    {benefit.title}
                  </h3>
                  <p className="text-subtext group-hover:text-[#111111]/90 font-medium leading-relaxed text-base md:text-lg">
                    {benefit.description}
                  </p>
                </div>
              </div>
