      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
          <div className="col-span-1 md:col-span-2">
            ...
            <div>
                <h5 className="font-extrabold text-[#111111] mb-4 uppercase tracking-widest text-xs">Our Locations</h5>
          ...
          <div>
            <h4 className="font-extrabold text-[#111111] mb-8 uppercase tracking-widest text-xs">Services</h4>
          ...
          <div>
            <h4 className="font-extrabold text-[#111111] mb-8 uppercase tracking-widest text-xs">Company</h4>
            <ul className="space-y-4 text-subtext font-bold">
