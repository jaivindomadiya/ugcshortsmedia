    ...
    <section id="services" className="py-32 bg-white relative">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="max-w-3xl mb-20">
          ...
          <p className="text-xl text-subtext font-medium mt-4 font-body leading-relaxed max-w-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {SERVICES.map((service, idx) => (
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-[#111111] mb-4 font-heading group-hover:translate-x-1 transition-transform">
                {service.title}
              </h3>
              <p className="text-subtext leading-relaxed text-lg font-medium font-body">
                {service.description}
              </p>
            </div>
          ))}
